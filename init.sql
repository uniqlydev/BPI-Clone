...
ALTER TYPE public.user_activity_type ADD VALUE 'LOGIN';
ALTER TYPE public.user_activity_type ADD VALUE 'TRANSFER';
ALTER TYPE public.user_activity_type ADD VALUE 'DEPOSIT';
ALTER TYPE public.user_activity_type ADD VALUE 'MANAGE_USERS';
ALTER TYPE public.user_activity_type ADD VALUE 'FLAGGING';
ALTER TYPE public.user_activity_type ADD VALUE 'CREATECHEQUE';
