...
INSERT INTO public.user_activity_audit (id, user_id, activity, end_point, created_at)
VALUES
(1, 'user-sktwivi6lx8zomzq', 'create', '/api/users/register', '2024-06-10 21:08:48.625');

INSERT INTO public.users (id, first_name, last_name, email, password, phone_number, role, created_at)
VALUES
